...
class RegisterByOrderTest extends GraphQlTestCase
{
    ...
    public function testRegisterByOrderIsNotPossibleForOrderOfRegisteredCustomerUser(): void
    {
    ...
    public function testRegisterByOrderIsNotPossibleForOrderOlderThanOneHour(): void
    {
    ...
    private function assertOrderCannotBePairedUserErrorIsReturned(array $response): void
    {
        ...
        $this->assertSame('order-cannot-be-paired-with-new-registration', $errors[0]['extensions']['userCode']);
    }
}
